...
// Déclaration de la classe InterruptedSleepThread qui implémente l'interface Runnable
    ...
    public void run() {
        ...
        for (String sentence : song) {
            try {
                ...
                // Capturer et traiter une InterruptedException en retournant de la méthode
                return;
            }
        }
    }
